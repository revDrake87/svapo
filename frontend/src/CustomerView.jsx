        ...
        <div className="md:w-1/3">
          <div className="bg-zinc-900 border border-white/5 p-6 rounded-2xl shadow-2xl sticky top-28">
            <h2 className="text-2xl font-bold mb-2 text-white flex items-center gap-2">
              <svg className="w-6 h-6 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
              Il Tuo Carrello
            </h2>
            ...
            {cart.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 opacity-50">
                ...
                <p className="text-zinc-500 text-center text-sm">Il carrello è vuoto.<br/>Aggiungi dei prodotti dal catalogo.</p>
              </div>
            ) : (
